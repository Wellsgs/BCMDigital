	...
	<div class="page_layout page_margin_top clearfix">
		...
		<div class="row page_margin_top">
			<div class="column column_3_3">
				<div class="row">
					<div class="post single">						
						<div class="post_content page_margin_top_section clearfix column_2_3">
				...
				<div class="row page_margin_top column_2_3">
				...
				<div class="row page_margin_top_section column_2_3">
				...
				<div class="row page_margin_top_section column_2_3">
					...
					<ul class="pagination page_margin_top_section">
						...
						<li class="right">
                            ...
                            <!------------------->
                            <h4 class="box_header page_margin_top_section column_1_1">Latest Posts</h4>
