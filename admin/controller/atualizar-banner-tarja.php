<?php		
	...
	if(!verificaSession("atualizar_banner_tarja.php", $conexao))
	...
	#region efetuando atualizacao de banner tarja
	if(
		!retornoQueryBolleana(
			"UPDATE banner_tarja SET 
	...
	if ($_FILES['foto_ilustrativa']['tmp_name'] != "") {
		$caminho      = "../datafiles/banner_tarja/".$_POST['id']."/";
		if(!is_dir($caminho)){
