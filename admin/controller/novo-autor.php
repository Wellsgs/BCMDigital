<?php		
	...
	if(
        ...
        #----[Melhorar]----
        $insert =   "INSERT INTO rede_social_autor (`id_autor`, `id_rede_social`, `ds_link`)".
                    "VALUES ('".$autor_id."','1','".$_POST['ds_link_facebook']."'),".
                    "       ('".$autor_id."','2','".$_POST['ds_link_twitter']."'),".
                    "       ('".$autor_id."','3','".$_POST['ds_link_instagram']."');" ;
        
        if(!retornoQueryBolleana($insert, $conexao)){            
                    echoJson($flag = 11, false);                
                }
        #endregion
