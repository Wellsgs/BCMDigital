<?php		
	...
	if(!verificaSession("cadastro_galerias.php", $conexao))
	...
	if(retornoQueryUmaField(
		"SELECT COUNT(*) AS total FROM galerias WHERE nm_galeria='".$_POST['nm_galeria']."' LIMIT 1;",
		$conexao,
		"total"
			) > 0){
	...
	#region efetuando cadastro da galeria
	if(
		!retornoQueryBolleana(
			"INSERT INTO galerias (`nm_galeria`) VALUES ('".$_POST['nm_galeria']."');"
			, $conexao)
	){
	...
	LogSistema(
			$_SERVER ['REQUEST_URI'], 
			"Está pagina faz o cadastro de um nova galeria", 
