<?php		
	...
	if(!verificaSession("cadastro_banner_tarja.php", $conexao))
	...
	if(
		!retornoQueryBolleana(
			"INSERT INTO banner_tarja (`tipo_id`, `cliente_id`, `segmento_id`,`nm_empresa`, `ds_link`, `ic_home`, `dt_inicio`, `dt_expiracao`,`artigo_id`) VALUES (".$_POST['tipo_id'].",".$_POST['cliente_id'].",".$_POST['segmento_id'].",'".$_POST['nm_empresa']."','".$_POST['ds_link']."',".$_POST['ic_home'].",'".$_POST['dt_inicio']."','".$_POST['dt_expiracao']."',".$_POST['artigo_id'].");"
			, $conexao)
	){
	...
	$caminho      = "../datafiles/banner_tarja/".$banner_tarja_id."/";
	if(!is_dir($caminho)){
	...
	LogSistema(
		$_SERVER ['REQUEST_URI'], 
		"Está pagina faz o cadastro de um novo banner tarja", 
