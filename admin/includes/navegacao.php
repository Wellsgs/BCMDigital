<nav role="navigation" id="page-leftbar">
                <!-- BEGIN SIDEBAR MENU -->
            <ul id="sidebar" class="acc-menu" style="top: 40px;">
                <li id="search">
                ...
                <li class="hasChild"><a href="javascript:;"><i class="fa fa-th"></i> <span>Layout Options</span> </a>
                    <ul class="acc-menu">
                ...
                <li class="hasChild"><a href="javascript:;"><i class="fa fa-list-ol"></i> <span>UI Elements</span> <span class="badge badge-indigo">4</span></a>
                    <ul class="acc-menu">
                ...
                <li class="hasChild"><a href="javascript:;"><i class="fa fa-tasks"></i> <span>UI Components</span> <span class="badge badge-info">12</span></a>
                    <ul class="acc-menu">
                ...
                <li class="hasChild"><a href="javascript:;"><i class="fa fa-table"></i> <span>Advanced Tables</span></a>
                    <ul class="acc-menu">
