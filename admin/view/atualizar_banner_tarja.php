<?php 
    ...
    LogSistema(
            $_SERVER ['REQUEST_URI'], 
            "Nestá pagina é possível fazer a atualização de um banner tarja", 
            "",
            $conexao
        );
    ...
    if($flag){
        $resp = mysql_query("SELECT * FROM banner_tarja WHERE id=".$_GET['id']." LIMIT 1;", $conexao);

        if(mysql_num_rows($resp) < 1)
            include "../avisos/banner-tarja-nao-encontrado.php";        
...
<div id="page-content">
    <div id='wrap'>
        <div id="page-heading">
            ...
            <h1>Alteração de Banner Tarja</h1>            
        </div>
        <?php 
            if(!$flag)
                include "../avisos/banner-tarja-nao-encontrado.php";
                  ...
                  <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h4>Alterar dados do banner tarja: <?php echo ($linha['nm_empresa'])?></h4>                            
                            </div>
                            <div class="panel-body collapse in">
                                <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                    <form action="#" id="atualizar-banner-tarja" name="atualizar-banner-tarja" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <?php 
                                                $caminho = "../datafiles/banner_tarja/".$linha['id'].""; 
...
$('#atualizar-banner-tarja').validate();

$("#atualizar-banner-tarja").on('submit', function(e){                                               

    var isvalidate=$("#atualizar-banner-tarja").valid();

    if(isvalidate){
        
        $.ajax({
            url:"../controller/atualizar-banner-tarja.php",
            type: "POST",
            ...
            success : function(data){
                if(data == "0")
                    alertaSucesso('Cadastrado com sucesso!', 'Sucesso', '../view/visualizar_banner_tarja.php');
                else if (data == "1")
