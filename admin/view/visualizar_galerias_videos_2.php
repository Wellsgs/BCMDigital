<?php 
    ...
    LogSistema(
            $_SERVER ['REQUEST_URI'], 
            "Nestá página é possível fazer a visualização das informações da galeria video selecionado", 
            "",
            $conexao
        );
    ...
    if(isset($_GET['id'])){
        if(!is_numeric($_GET['id']) || $_GET['id'] < 1)
            ...
            $resp = mysql_query("SELECT id, nm_galeria FROM galeriavideos WHERE id=".$_GET['id']." ORDER BY nm_galeria LIMIT 1;", $conexao);
...
<div id="page-content">
    <div id='wrap'>
        <div id="page-heading">
            ...
            <h1>Visualizar Detalhes da Galeria Vídeo</h1>            
        </div>
        <div class="main">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">                                                                                                             
                        ...
                        <div class="panel panel-primary">                  
                            ...
                            <div class="panel-heading">
                                <h4>Galeria: <?php echo ($linha['nm_galeria'])?></h4>                            
                            </div>
                            <!-- / ELEMENTO TITULO -->
                            <!-- / ELEMENTO CORPO -->
                            <div class="widget-content">                    
                                ...
                                <div class="col-md-6">
                                    <b>Nome do Galeria:</b><br />
                                    <?php echo $linha['nm_galeria'];?>
                                    <hr>
                                </div> 
                                <div class="col-md-12">
                                    &nbsp;
