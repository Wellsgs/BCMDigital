<?php 
    ...
    LogSistema(
            $_SERVER ['REQUEST_URI'], 
            "Nestá pagina é possível fazer alteração de cargos de funcionários, alterar sua ordem hierárquica, e deletar", 
            "",
            $conexao
        );
?>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body collapse in">
                                <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                    <form action="#" id="alterar-cargo-funcionario" name="cadastrar-cargo-funcionario" method="post" class="form-horizontal">
                                        <div class="form-group">
                                            <label class="col-sm-1 control-label">Nome</label>
                                            <div class="col-sm-11">
                                                <input type="text" class="form-control required" placeholder="Nome do cargo" name="nome" value="<?php echo $_REQUEST['nome'];?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
...
$(function () {
    ...
    $('#alterar-cargo-funcionario').validate();

    $("#btn_alterar").click(function(){
        
        var isvalidate=$("#alterar-cargo-funcionario").valid();
        if(isvalidate){                
            $.ajax(
                {               
                    url:"../controller/atualizar-cargos-funcionario.php",
                    type: "POST",
                    data: $("#alterar-cargo-funcionario").serializeArray(),
