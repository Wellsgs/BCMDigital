<?php 
    ...
    LogSistema(
            $_SERVER ['REQUEST_URI'], 
            "Nestá pagina é possível fazer o cadastro de banner fixo", 
            "",
            $conexao
        );    
?>
                  ...
                  <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h4>Cadastro de Banner Fixo</h4>                            
                            </div>
                            <div class="panel-body collapse in">
                                <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                    <form id="cadastrar-banner-fixo" method="post" role="form" class="col-md-12" enctype="multipart/form-data">
...
$('#cadastrar-banner-fixo').validate();

$("#cadastrar-banner-fixo").on('submit', function(e){                                               

    var isvalidate=$("#cadastrar-banner-fixo").valid();
    if(isvalidate){
        
        $.ajax({
            url:"../controller/novo-banner-fixo.php",
            type: "POST",
