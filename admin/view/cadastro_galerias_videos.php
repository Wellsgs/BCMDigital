<?php 
    ...
    LogSistema(
            $_SERVER ['REQUEST_URI'], 
            "Nestá pagina é possível fazer o cadastro de galeria videos", 
            "",
            $conexao
        );    
?>
...
<div id="page-content">
    <div id='wrap'>
        <div id="page-heading">
            ...
            <h1>Cadastro de Galeria Vídeos</h1>            
        </div>
        <div class="main">
            <div class="container">
                <div class="row">
                  <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h4>Cadastro de galeria vídeo</h4>                            
                            </div>
                            <div class="panel-body collapse in">
                                <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                    <form id="cadastrar-galerias-videos" role="form" class="col-md-12">
                                    
                                        <div class="col-md-12">
                                            <label>Nome do galeria vídeo:</label>
...
//region cadastro galeria videos
$('#cadastrar-galerias-videos').validate();

$("#cadastrar-galerias-videos button").click(function(){                                                 

    var isvalidate=$("#cadastrar-galerias-videos").valid();
    if(isvalidate){
        $.ajax(
            {               
                type:"POST",
                url:"../controller/nova-galeria-videos.php",
                data:$("#cadastrar-galerias-videos").serialize(),
                success : function(data){
                    if(data == "0")
                        alertaSucesso('Cadastrado com sucesso!', 'Sucesso', '../view/visualizar_galerias_videos.php');
                    else if (data == "1")
