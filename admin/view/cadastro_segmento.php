<?php 
    ...
    LogSistema(
            $_SERVER ['REQUEST_URI'], 
            "Nestá pagina é possível fazer o cadastro de segmento", 
            "",
            $conexao
        );    
?>
                  ...
                  <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h4>Cadastro de segmento</h4>                            
                            </div>
                            <div class="panel-body collapse in">
                                <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                    <form id="cadastrar-segmento" role="form" class="col-md-12">
                                    
                                        <div class="col-md-12">
                                            <label>Nome do segmento:</label>
                                            <input type="text" name="nm_segmento" placeholder="Nome do segmento" class="form-control required" />
                                        </div>                                                                        
                                        <div class="col-md-12">
                                            <label>Nome do css:</label>
                                            <input type="text" name="nm_css" placeholder="Nome do css" class="form-control required" />
                                        </div>                
...
$('#cadastrar-segmento').validate();

$("#cadastrar-segmento button").click(function(){                                                 

    var isvalidate=$("#cadastrar-segmento").valid();
    if(isvalidate){
        $.ajax(
            {               
                type:"POST",
                url:"../controller/novo-segmento.php",
                data:$("#cadastrar-segmento").serialize(),
                success : function(data){
                    if(data == "0")
                        alertaSucesso('Cadastrado com sucesso!', 'Sucesso', '../view/visualizar_segmentos.php');
                    else if (data == "1")
