<?php
    ...
    include '../includes/verifica_token.php';
...
<head>
	<meta charset="utf-8">
	<title><?php echo $pg->Texto('nome-sistema'); ?></title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="atendimento@ldpvat.com.br">
	<meta name="author" content="Lemon Labs">

<!-- <link href="assets/less/styles.less" rel="stylesheet/less" media="all">  -->
    <link rel="stylesheet" href="../view/assets/css/styles.css?=121">
    <link href='http://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600' rel='stylesheet' type='text/css'>

     
        <link href='../view/assets/demo/variations/default.css' rel='stylesheet' type='text/css' media='all' id='styleswitcher'> 
    
            <link href='../view/assets/demo/variations/default.css' rel='stylesheet' type='text/css' media='all' id='headerswitcher'> 
...
<link rel='stylesheet' type='text/css' href='../view/assets/plugins/form-daterangepicker/daterangepicker-bs3.css' /> 
<link rel='stylesheet' type='text/css' href='../view/assets/plugins/fullcalendar/fullcalendar.css' /> 
<link rel='stylesheet' type='text/css' href='../view/assets/plugins/form-markdown/css/bootstrap-markdown.min.css' /> 
<link rel='stylesheet' type='text/css' href='../view/assets/plugins/codeprettifier/prettify.css' /> 
<link rel='stylesheet' type='text/css' href='../view/assets/plugins/form-toggle/toggles.css' />
...
<body class="<?php if (isset($_COOKIE["admin_leftbar_collapse"])) echo ($_COOKIE['admin_leftbar_collapse'] . " "); // check collapse state with php
    ...
    <header class="navbar navbar-inverse <?php if (isset($_COOKIE["fixed-header"])) {echo 'navbar-static-top';} else {echo 'navbar-fixed-top';} ?>" role="banner">
        <a id="leftmenu-trigger" class="tooltips" data-toggle="tooltip" data-placement="right" title="Alternar Menu"></a>
        <!--<a id="rightmenu-trigger" class="tooltips" data-toggle="tooltip" data-placement="left" title="Alternar"></a>-->

        <div class="navbar-header pull-left">
            <a class="navbar-brand" href="inicio.php"><?php echo $pg->Texto('nome-sistema'); ?></a>
        </div>

        <ul class="nav navbar-nav pull-right toolbar">
        	<li class="dropdown">
        		<a href="#" class="dropdown-toggle username" data-toggle="dropdown"><span class="hidden-xs"><?php echo ($_SESSION['fnome']);?> <i class="fa fa-caret-down"></i></span><img src="../includes/imagem_usuario_3.php" alt="Dangerfield" /></a>
        		<ul class="dropdown-menu userinfo arrow">
        			<li class="username">
                        <a href="#">
        				    <div class="pull-left"><img src="../includes/imagem_usuario_3.php" alt="Jeff Dangerfield"/></div>
        				    <div class="pull-right"><h5>Olá, <?php echo ($_SESSION['fnome']);?>!</h5></div>
                        </a>
        			</li>
        			<li class="userlinks">
        				<ul class="dropdown-menu">        					
                            <li><a href="meus_dados.php">Meus dados <i class="pull-right fa fa-pencil"></i></a></li>        					
        					<li class="divider"></li>
                            <li><a href="../view/logoff.php" class="text-right">Sair</a></li>
        				</ul>
        			</li>
        		</ul>
        	</li>
        	<!--li class="dropdown">
                <a href="#" class="hasnotifications dropdown-toggle" data-toggle='dropdown'><i class="fa fa-cog"></i></a>
                <ul class="dropdown-menu messages arrow">
                    <li class="dd-header">
                        <span>Configurações</span>                        
                    </li>
                    <div class="scrollthis">                        
                        <li><a href="../controller/modulos.php?acao=listar">                            
                            <img src="../view/assets/demo/avatar/aniss.png" alt="avatar" />
                            <div><span class="name">Modulos</span><span class="msg">Lista dos Módulos.</span></div>
                        </a></li>
                        <li><a href="../controller/acidentes.php?acao=listar">
                            <img src="../view/assets/demo/avatar/aniss.png" alt="avatar" />
                            <div><span class="name">Tipos de Acidentes</span><span class="msg">Lista dos tipos de acidentes.</span></div>
                        </a></li>                        
                    </div>
                    <li class="dd-footer"><a href="javascript:;"></a></li>
                </ul>
            </li-->
            <!--Notificacoes-->
            <!--<li class="dropdown">
