<?php 
    ...
    LogSistema(
            $_SERVER ['REQUEST_URI'], 
            "Nestá pagina é possível fazer a atualização de uma galeria", 
            "",
            $conexao
        );
    ...
    if($flag){
        $resp = mysql_query("SELECT * FROM galerias WHERE id=".$_GET['id']." LIMIT 1;", $conexao);
                  ...
                  <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h4>Alterar dados da galeria: <?php echo strtoupper($linha['nm_galeria'])?></h4>                            
                            </div>
                            <div class="panel-body collapse in">
                                <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                    <form action="#" id="atualizar-galeria" name="atualizar-galeria" method="post" class="form-horizontal">
                                        <div class="col-md-12">
...
$('#atualizar-galeria').validate();

$("#atualizar-galeria button").click(function(){                                                 
    
    var isvalidate=$("#atualizar-galeria").valid();
    if(isvalidate){
        $.ajax(
            {               
                type:"POST",
                url:"../controller/atualizar-galeria.php",
                data:$("#atualizar-galeria").serialize(),
                success : function(data){
                    if(data == "0")
                        alertaSucesso('Alterado com sucesso!', 'Sucesso', '../view/visualizar_galerias.php');
                    else if (data == "1")
