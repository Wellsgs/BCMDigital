<?php 
    ...
    LogSistema(
            $_SERVER ['REQUEST_URI'], 
            "Nestá página é possível fazer a visualização das informações dos banner fixo", 
            "",
            $conexao
        );
?>
...
<div id="page-content">
    <div id='wrap'>
        <div id="page-heading">
            ...
            <h1>Banners Fixos - <a class="btn btn-success" href="cadastro_banner_fixo.php"><i class="fa fa-plus"></i> Adicionar Novo Banner</a></h1>            
        </div>
        <?php
            /*if(isset($_GET['id'])){
            ...
            $paginacao = new Paginacao($conexao, 15, "pagina", "visualizar_banner_fixo.php");
            
            $paginacao->AddTabela("banner_fixo");
...
<script>
    ...
    $("#bnt-limpar-filtros").click(function(){        
        ...
        $('#id').attr('value','');
        document.location.href="visualizar_banner_fixo.php";                    
        return false;
    });
    //endregion
    ...
    $('.atualizar-banner').click(function() {
        ...
        document.location.href="atualizar_banner_fixo.php?id="+codigo;
    });
    //endregion
