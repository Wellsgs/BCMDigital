<?php 
    ...
    LogSistema(
            $_SERVER ['REQUEST_URI'], 
            "Nestá pagina é possível fazer o cadastro de ultimas noticias", 
            "",
            $conexao
        );    
?>
...
<div id="page-content">
    <div id='wrap'>
        <div id="page-heading">
            ...
            <h1>Cadastro de Última Notícia</h1>            
        </div>
        <div class="main">
            <div class="container">
                <div class="row">
                  <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h4>Cadastro de Última Notícia</h4>                            
                            </div>
                            <div class="panel-body collapse in">
                                <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                    <form id="cadastrar-ultimas-noticias" method="post" role="form" class="col-md-12" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="titulo_noticia" placeholder="Título da Notícia" class="form-control required" maxlength="150" />
                                        </div> 
                                        <div class="col-md-12">
                                            &nbsp;
                                        </div>
...
//region cadastro ultimas noticias
$('#cadastrar-ultimas-noticias').validate();

$("#cadastrar-ultimas-noticias").on('submit', function(e){                                               

    var isvalidate=$("#cadastrar-ultimas-noticias").valid();
    if(isvalidate){
        
        $.ajax({
            url:"../controller/novo-ultimas-noticias.php",
            type: "POST",
