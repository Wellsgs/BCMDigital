<?php 
    ...
    if(isset($_GET['id'])){
        if(!is_numeric($_GET['id']) || $_GET['id'] < 1)
            ...
            $resp = mysql_query("SELECT * FROM clientes WHERE id=".$_GET['id']." ORDER BY nm_cliente LIMIT 1;", $conexao);
...
<div id="page-content">
    <div id='wrap'>
        <div id="page-heading">
            ...
            <h1>Visualizar Detalhes do Cliente</h1>            
        </div>
        <div class="main">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">                                                                                                             
                        ...
                        <div class="panel panel-primary">                  
                            ...
                            <div class="panel-heading">
                                <h4>Cliente: <?php echo strtoupper($linha['nm_cliente'])?></h4>                            
                            </div>
                            <!-- / ELEMENTO TITULO -->
                            <!-- / ELEMENTO CORPO -->
                            <div class="widget-content">                    
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php echo $linha['nm_cliente'];?>
                                    <hr>
                                </div>
                                <div class="col-md-6">
                                    <b>Email:</b><br />
                                    <?php echo $linha['ds_email'];?>
                                    <hr>
                                </div> 
                                <div class="col-md-6">
                                    <b>Contato:</b><br />
                                    <?php echo $linha['nm_contato'];?>
                                    <hr>
                                </div> 
                                <div class="col-md-6">
                                    <b>Telefone:</b><br />
                                    <?php echo $linha['nr_telefone'];?>
                                    <hr>
                                </div> 
                                <div class="col-md-12">
                                    &nbsp;
