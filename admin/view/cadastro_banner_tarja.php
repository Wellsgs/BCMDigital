<?php 
    ...
    LogSistema(
            $_SERVER ['REQUEST_URI'], 
            "Nestá pagina é possível fazer o cadastro de banner tarja", 
            "",
            $conexao
        );    
?>
...
<div id="page-content">
    <div id='wrap'>
        <div id="page-heading">
            ...
            <h1>Cadastro de Banner Tarja</h1>            
        </div>
        <div class="main">
            <div class="container">
                <div class="row">
                  <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h4>Cadastro de Banner Tarja</h4>                            
                            </div>
                            <div class="panel-body collapse in">
                                <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                    <form id="cadastrar-banner-tarja" method="post" role="form" class="col-md-12" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select name="artigo_id" class="form-control">
                                                ...
                                                <?php $sql = mysql_query("SELECT id, ds_titulo FROM artigos WHERE ds_titulo <> ''  ORDER BY ds_titulo", $conexao);
                                                    while($result = mysql_fetch_array($sql)){
                                                        echo "<OPTION VALUE='".$result['id']."'>".$result['ds_titulo']."</OPTION>";
                                                    }
                                                ?>
                                            </select> 
                                        </div>    
...
//region cadastro banner
$('#cadastrar-banner-tarja').validate();

$("#cadastrar-banner-tarja").on('submit', function(e){                                               

    var isvalidate=$("#cadastrar-banner-tarja").valid();
    if(isvalidate){
        
        $.ajax({
            url:"../controller/novo-banner-tarja.php",
            type: "POST",
