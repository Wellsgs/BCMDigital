<?php 
    ...
    LogSistema(
            $_SERVER ['REQUEST_URI'], 
            "Nestá página é possível fazer a visualização das informações das galerias videos", 
            "",
            $conexao
        );
?>
...
<div id="page-content">
    <div id='wrap'>
        <div id="page-heading">
            ...
            <h1>Galerias Vídeos - <a class="btn btn-success" href="cadastro_galerias_videos.php"><i class="fa fa-plus"></i> Adicionar Nova Galeria Vídeo</a></h1>            
        </div>
        <?php
            /*if(isset($_GET['id'])){
            ...
            $paginacao = new Paginacao($conexao, 15, "pagina", "visualizar_galerias_videos.php");
            
            $paginacao->AddTabela("galeriavideos");
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">                                                                                                             
                        ...
                        <div class="panel panel-primary">                  
                            <!-- / ELEMENTO TITULO -->
                            <div class="panel-heading">
                                <h4>Lista de Galerias Vídeos</h4>                            
                            </div>
                            <!-- / ELEMENTO TITULO -->
                            <!-- / ELEMENTO CORPO -->
                            <div class="widget-content">                    
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody> 
                                        ...
                                        ?>
                                                ...
                                                <td class="td-actions">
                                                    <center>
                                                    <a rel="<?php echo $value['id'];?>" class="btn btn-xs btn-warning atualizar-galeria-video tooltips" data-toggle="tooltip" data-placement="top" title="Editar">
                                                        <i class="fa fa-edit"></i>
                                                    </a>                                                    
                                                    <a rel="<?php echo $value['id'];?>" class="btn btn-xs btn-default visualizar-galeria-video tooltips" data-toggle="tooltip" data-placement="top" title="Visualizar">
                                                        <i class="fa fa-eye"></i>
                                                    </a>                                       
                                                </center>                                                   
                                                </td>
...
<script>
    ...
    //region limpar filtros galeria videos
    $("#bnt-limpar-filtros").click(function(){        
        $('#nm_galeria').attr('value','');
        $('#id').attr('value','');
        document.location.href="visualizar_galerias_videos.php";                    
        return false;
    });
    //endregion

    //region visualizar galeria videos
    $('.visualizar-galeria-video').click(function() {
        var codigo = parseInt($(this).attr('rel'));
        document.location.href="visualizar_galerias_videos_2.php?id="+codigo;
    });
    //endregion  

    //region atualizar galeria videos
    $('.atualizar-galeria-video').click(function() {
        var codigo = parseInt($(this).attr('rel'));
        document.location.href="atualizar_galerias_videos.php?id="+codigo;
    });
    //endregion
