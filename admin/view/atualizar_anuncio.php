<?php 
    ...
    LogSistema(
            $_SERVER ['REQUEST_URI'], 
            "Nestá pagina é possível fazer a atualização de um anuncio", 
            "",
            $conexao
        );
    ...
    if($flag){
        $resp = mysql_query("SELECT * FROM anuncios WHERE id=".$_GET['id']." LIMIT 1;", $conexao);

        if(mysql_num_rows($resp) < 1)
            include "../avisos/anuncio-nao-encontrado.php";        
                  ...
                  <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h4>Alterar dados do anúncio: <?php echo ($linha['nm_empresa'])?></h4>                            
                            </div>
                            <div class="panel-body collapse in">
                                <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                                    <form action="#" id="atualizar-anuncio" name="atualizar-anuncio" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <?php 
                                                $caminho = "../datafiles/anuncios/".$linha['id'].""; 
...
<script>
//region atualizar anuncio
$('#atualizar-anuncio').validate();

$("#atualizar-anuncio").on('submit', function(e){                                               

    var isvalidate=$("#atualizar-anuncio").valid();

    if(isvalidate){
        
        $.ajax({
            url:"../controller/atualizar-anuncio.php",
            type: "POST",
