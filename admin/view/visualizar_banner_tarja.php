<?php 
    ...
    LogSistema(
            $_SERVER ['REQUEST_URI'], 
            "Nestá página é possível fazer a visualização das informações dos banner tarda", 
            "",
            $conexao
        );
?>
...
<div id="page-content">
    <div id='wrap'>
        <div id="page-heading">
            ...
            <h1>Banners Tarja - <a class="btn btn-success" href="cadastro_banner_tarja.php"><i class="fa fa-plus"></i> Adicionar Novo Banner</a></h1>            
        </div>
        <?php
            /*if(isset($_GET['id'])){
            ...
            $paginacao = new Paginacao($conexao, 15, "pagina", "visualizar_banner_tarja.php");
            
            $paginacao->AddTabela("banner_tarja");
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-primary">                    
                            ...
                            <div class="panel-heading">
                                <h4>Filtrar Banner Tarja</h4>                            
                            </div>
                            <!-- / ELEMENTO TITULO -->
                            <!-- / ELEMENTO CORPO -->
                            <div class="widget-content">
                                <table class="table table-striped table-bordered">
                                    <form id="filtro-banner-tarja" role="form" class="col-md-12">                          
                                        ...
                                        <div class="col-md-6 well">
                                            <label>ID:</label>
                                            <input value="<?php echo $filtro_id; ?>" type="text" id="id" name="id" placeholder="ID do banner" class="form-control" />
                                        </div>
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody> 
                                        ...
                                        ?>
                                                ...
                                                <td class="td-actions">
                                                    <center>
                                                    <a rel="<?php echo $value['id'];?>" class="btn btn-xs btn-warning atualizar-banner tooltips" data-toggle="tooltip" data-placement="top" title="Editar">
...
<script>
    ...
    //region limpar filtros banner
    $("#bnt-limpar-filtros").click(function(){        
        $('#nm_empresa').attr('value','');
        $('#id').attr('value','');
        document.location.href="visualizar_banner_tarja.php";                    
        return false;
    });
    //endregion
    ...
    $('.atualizar-banner').click(function() {
        var codigo = parseInt($(this).attr('rel'));
        document.location.href="atualizar_banner_tarja.php?id="+codigo;
    });
    //endregion
