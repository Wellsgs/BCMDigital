<?php 
    ...
    LogSistema(
            $_SERVER ['REQUEST_URI'], 
            "Nestá página é possível fazer a visualização das informações da galeria selecionado", 
            "",
            $conexao
        );
    ...
    if(isset($_GET['id'])){
        if(!is_numeric($_GET['id']) || $_GET['id'] < 1)
            ...
            $resp = mysql_query("SELECT id, nm_galeria FROM galerias WHERE id=".$_GET['id']." ORDER BY nm_galeria LIMIT 1;", $conexao);
...
<div id="page-content">
    <div id='wrap'>
        <div id="page-heading">
            ...
            <h1>Visualizar Detalhes da Galeria</h1>            
        </div>
        <div class="main">
            <div class="container">
                <div class="row">
