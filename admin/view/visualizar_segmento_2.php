<?php 
    ...
    LogSistema(
            $_SERVER ['REQUEST_URI'], 
            "Nestá página é possível fazer a visualização das informações do segmento selecionado", 
            "",
            $conexao
        );
    ...
    if(isset($_GET['id'])){
        if(!is_numeric($_GET['id']) || $_GET['id'] < 1)
            ...
            $resp = mysql_query("SELECT id, nm_segmento, nm_css FROM segmentos WHERE id=".$_GET['id']." ORDER BY nm_segmento LIMIT 1;", $conexao);
...
<div id="page-content">
    <div id='wrap'>
        <div id="page-heading">
            ...
            <h1>Visualizar Detalhes do Segmento</h1>            
        </div>
        <div class="main">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">                                                                                                             
                        ...
                        <div class="panel panel-primary">                  
                            ...
                            <div class="panel-heading">
                                <h4>Segmento: <?php echo strtoupper($linha['nm_segmento'])?></h4>                            
                            </div>
                            <!-- / ELEMENTO TITULO -->
                            <!-- / ELEMENTO CORPO -->
                            <div class="widget-content">                    
                                ...
                                <div class="col-md-6">
                                    <b>Nome do Segmento:</b><br />
                                    <?php echo $linha['nm_segmento'];?>
                                    <hr>
                                </div> 
                                <div class="col-md-6">
                                    <b>Nome do Css:</b><br />
                                    <?php echo $linha['nm_css'];?>
                                    <hr>
                                </div> 
                                <div class="col-md-12">
                                    &nbsp;
